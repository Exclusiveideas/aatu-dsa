  ...
  const router = useRouter();
    ...
    return (
      <div
        ...
        style={{ flex: topP ? (firstTopP ? ".6" : ".4") : "1", paddingBottom: topP ? '3rem' : '1.5rem', minHeight: allNewsPage && '350px' }}
      >
        ...
        <div className="infoWrapper" style={{ gap: topP ? '.5rem' : '.2rem'}}>
          ...
          <div style={{ fontSize: topP ? '12px': '10px', padding: topP ? '.7rem 1.5rem' : '.5rem 1.2rem', marginTop: topP ? '1rem' : '.3rem'}} className="readMoreBtn" onClick={gotoSingleNewsPage}>
